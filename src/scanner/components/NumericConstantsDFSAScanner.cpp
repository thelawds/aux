...
components::NumericConstantsDFSAScanner::NumericConstantsDFSAScanner(IIndexedStream<CommonCharType> &stream) : _stream(stream) {
    ...
    S_0->addTransition(delimiter(ANY), S_Finish, SKIP_SYMBOL);
    ...
    S_Dec_Double_E_All->addTransition(delimiter(ANY), S_Finish, SKIP_SYMBOL);
    ...
    S_Hex_0->addTransition(delimiter(ANY), S_Finish, SKIP_SYMBOL);
    ...
    S_Hex->addTransition(delimiter(ANY), S_Finish, SKIP_SYMBOL);

    S_Hex_Double->addTransition(numeric(ALL_HEX), S_Hex_Double);
    S_Hex_Double->addTransition(numeric(HEX_EXP), S_Hex_Double_P);
    S_Hex_Double->addTransition(delimiter(ANY), S_Finish, SKIP_SYMBOL);
